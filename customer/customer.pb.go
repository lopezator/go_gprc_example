...
func (*CustomerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_640fc6e50d1c5944, []int{0}
}
...
func (*CustomerRequest_Address) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_640fc6e50d1c5944, []int{0, 0}
}
...
func (*CustomerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_640fc6e50d1c5944, []int{1}
}
...
func (*CustomerFilter) Descriptor() ([]byte, []int) {
	return fileDescriptor_customer_640fc6e50d1c5944, []int{2}
}
...
func init() { proto.RegisterFile("customer.proto", fileDescriptor_customer_640fc6e50d1c5944) }

var fileDescriptor_customer_640fc6e50d1c5944 = []byte{
